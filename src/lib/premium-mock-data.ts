...
export const PREMIUM_MOCK_NFTS: NFT3D[] = [
  ...
  },
  {
    ...
    ownerId: MOCK_IDENTITY_ID,
    geometry3d: createParametricGeometry('prism', [3, 2], []),
    geometryType: 'parametric',
  ...
  },
  {
    ...
    ownerId: MOCK_IDENTITY_ID,
    geometry3d: createParametricGeometry('box', [2, 1.5, 1], []),
    geometryType: 'parametric',
    colors: ['#00D4FF', '#8B5CF6', '#FF0080'],
    edition: 1,
    maxEditions: 75,
  ...
  },
  {
    ...
    ownerId: MOCK_IDENTITY_ID,
    geometry3d: createParametricGeometry('prism', [5, 2], []),
    geometryType: 'parametric',
    colors: ['#FF0080', '#00D4FF', '#8B5CF6'],
    edition: 1,
    maxEditions: 50,
  ...
  },
  {
    ...
    ownerId: MOCK_IDENTITY_ID,
    geometry3d: createParametricGeometry('prism', [6, 2], []),
    geometryType: 'parametric',
    colors: ['#8B5CF6', '#FF0080', '#00D4FF'],
    edition: 1,
    maxEditions: 50,
  ...
  },
  {
    ...
    ownerId: MOCK_IDENTITY_ID,
    geometry3d: createParametricGeometry('prism', [8, 2], []),
    geometryType: 'parametric',
    colors: ['#00D4FF', '#8B5CF6', '#FF0080'],
    edition: 1,
    maxEditions: 40,
  ...
  },
  {
    ...
    ownerId: MOCK_IDENTITY_ID,
    geometry3d: createParametricGeometry('dodecahedron', [1.5], []),
    geometryType: 'parametric',
    colors: ['#00D4FF', '#8B5CF6', '#FF0080'],
    edition: 1,
    maxEditions: 15,
  ...
  },
  {
    ...
    ownerId: MOCK_IDENTITY_ID,
    geometry3d: createParametricGeometry('icosahedron', [1.5], []),
    geometryType: 'parametric',
    colors: ['#FF0080', '#00D4FF', '#8B5CF6'],
    edition: 1,
    maxEditions: 15,
