...
export interface WasmSdkWrapperConfig {
...
export class WasmSdkWrapper {
  private sdk: any;
  private config: WasmSdkWrapperConfig;
  private originalFetch: typeof fetch;

  constructor(config: WasmSdkWrapperConfig) {
    this.config = config;
...
export async function createWasmSdk(network: 'testnet' | 'mainnet' = 'testnet') {
